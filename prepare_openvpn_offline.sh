...
PKCS11_DIR="${OFFLINE_DIR}/libpkcs11-helper"

# --------------------------
# Criar estrutura de diretórios
# --------------------------
mkdir -p "$SRC_DIR" "$RPM_DIR" "$PKCS11_DIR"
...
# --------------------------
# Baixar código-fonte do pkcs11-helper
# --------------------------
...
[root@localhost ~]#
[root@localhost ~]#
[root@localhost ~]# cat prepare_openvpn_offline.sh
#!/bin/bash
set -e
